    ...
    <div class="content-body">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    <div class="mb-4 pb-3">
                        <a href="{{ route('berita.create') }}" class="btn btn-success btn-round">
                                        ...
                                        @foreach($beritaList as $row)
                                            <tr>
                                                ...
                                                <td class="d-flex gap-1">
                                                    <a href="{{ route('berita.edit', $row->id) }}" class="btn btn-success btn-sm" title="Edit">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                    <form action="{{ route('berita.destroy', $row->id) }}" method="POST" onsubmit="return confirm('Yakin hapus berita ini?')">
                                                        @csrf
                                                        @method('DELETE')
