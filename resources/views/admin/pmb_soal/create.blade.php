                    ...
                    <div class="filter cm-content-box box-primary">
                        ...
                        <div class="cm-content-body form excerpt">
                            ...
                            <div class="card-body pb-4">
                                <form action="{{ url('pmb/soal') }}" method="POST" id="form-soal-pmb">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            <label class="form-label">Soal <span class="text-danger">*</span></label>
                                            <textarea class="form-control js-editor" name="soal" rows="5" required>{{ old('soal') }}</textarea>
                                        </div>
                                    ...
                                    @php
                                        ...
                                        $oldKunciIndex = old('kunci_index', 0);
                                    @endphp
