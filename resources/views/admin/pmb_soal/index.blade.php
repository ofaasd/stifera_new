    ...
    <div class="content-body">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    <div class="mb-4 pb-3">
                        <a href="{{ url('pmb/soal/create') }}" class="btn btn-success btn-round">
                            <i class="fa-solid fa-plus me-1"></i> Tambah Soal PMB
                        </a>
                    </div>
                    <div class="filter cm-content-box box-primary">
                        ...
                        <div class="cm-content-body form excerpt">
                            ...
                            <div class="card-body pb-4">
                                <table id="order-table" class="table table-striped table-bordered nowrap align-middle">
                                    <thead>
                                        <tr>
                                            <th width="5">No</th>
                                            <th>Soal</th>
                                    ...
                                    <tbody>
                                        @foreach($soalList as $row)
                                            <tr>
                                                ...
                                                <td>{!! $row->soal !!}</td>
                                                <td>{{ $row->pilihan_soal_count }}</td>
                                                <td>{{ strtoupper((string) optional($row->kunciJawaban)->kunci) ?: '-' }}</td>
                                                <td>
                                                ...
                                                <td class="d-flex gap-1">
                                                    <a href="{{ url('pmb/soal/' . $row->id . '/edit') }}"
                                                        class="btn btn-success btn-sm" title="Edit">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                    <form action="{{ url('pmb/soal/' . $row->id) }}" method="POST"
