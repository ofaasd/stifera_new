            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="mb-4 pb-3 d-flex gap-2 flex-wrap">
                        <a href="{{ url('simpeg/MeninggalkanPekerjaan/create') }}" class="btn btn-success btn-round">
                    ...
                    <div class="filter cm-content-box box-primary mb-3">
                        ...
                        <div class="cm-content-body form excerpt p-3">
                            <form method="GET" action="{{ url('simpeg/MeninggalkanPekerjaan') }}" class="row g-2 align-items-end">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-2">
                                    <a href="{{ url('simpeg/MeninggalkanPekerjaan') }}" class="btn btn-light w-100">Reset</a>
                                </div>
                            </form>
                        </div>
                    </div>
                                        ...
                                        @foreach($izinList as $row)
                                            <tr>
                                                ...
                                                <td class="d-flex gap-1">
                                                    ...
                                                    <form action="{{ url('simpeg/MeninggalkanPekerjaan/' . $row->id) }}" method="POST" onsubmit="return confirm('Yakin hapus data izin ini?')">
                                                        @csrf
                                                        @method('DELETE')
