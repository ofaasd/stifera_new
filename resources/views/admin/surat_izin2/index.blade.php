            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="mb-4 pb-3 d-flex gap-2 flex-wrap">
                        <a href="{{ url('simpeg/SuratIzin2/create') }}" class="btn btn-success btn-round">
                    ...
                    <div class="filter cm-content-box box-primary mb-3">
                        ...
                        <div class="cm-content-body form excerpt p-3">
                            <form method="GET" action="{{ url('simpeg/SuratIzin2') }}" class="row g-2 align-items-end">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-2">
                                    <a href="{{ url('simpeg/SuratIzin2') }}" class="btn btn-light w-100">Reset</a>
                                </div>
                            </form>
                        </div>
                    </div>
                                        ...
                                        @foreach($suratList as $row)
                                            <tr>
                                                ...
                                                <td class="d-flex gap-1">
                                                    ...
                                                    <form action="{{ url('simpeg/SuratIzin2/' . $row->id) }}" method="POST" onsubmit="return confirm('Yakin hapus surat izin ini?')">
                                                        @csrf
                                                        @method('DELETE')
