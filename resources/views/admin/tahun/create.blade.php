                    ...
                    <div class="filter cm-content-box box-primary">
                        ...
                        <div class="cm-content-body form excerpt">
                            ...
                            <div class="card-body pb-4">
                                <form action="{{ url('master/tahun') }}" method="POST">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-2 mb-3">
                                            <label class="form-label">ID Tahun <span class="text-danger">*</span></label>
                                            <input type="number" class="form-control" name="id_tahun" value="{{ old('id_tahun') }}" required>
                                        </div>
                                        <div class="col-md-2 mb-3">
                                            <label class="form-label">Awal <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" name="awal" value="{{ old('awal') }}" placeholder="2025" required>
                                        </div>
                                        <div class="col-md-2 mb-3">
                                            <label class="form-label">Akhir <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" name="akhir" value="{{ old('akhir') }}" placeholder="2026" required>
                                        </div>
                                        <div class="col-md-2 mb-3">
                                            <label class="form-label">Jenis <span class="text-danger">*</span></label>
                                            <select class="form-control" name="jenis" required>
                                                <option value="1" {{ old('jenis', '1') === '1' ? 'selected' : '' }}>Ganjil</option>
                                                <option value="2" {{ old('jenis') === '2' ? 'selected' : '' }}>Genap</option>
                                            </select>
                                        </div>
                                        <div class="col-md-2 mb-3">
                                            <label class="form-label">Aktif <span class="text-danger">*</span></label>
                                            <select class="form-control" name="is_aktif" required>
                                                <option value="1" {{ old('is_aktif', '1') === '1' ? 'selected' : '' }}>Ya</option>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <select class="form-control" name="tipe_mhs" required>
                                                <option value="1" {{ old('tipe_mhs', '1') === '1' ? 'selected' : '' }}>Reguler</option>
                                                <option value="2" {{ old('tipe_mhs') === '2' ? 'selected' : '' }}>RPL</option>
                                            </select>
                                        </div>
                                        <div class="col-md-3 mb-3">
                                            <label class="form-label">Kuesioner <span class="text-danger">*</span></label>
                                            <select class="form-control" name="kuesioner" required>
                                                <option value="0" {{ old('kuesioner', '0') === '0' ? 'selected' : '' }}>Tidak</option>
                                                <option value="1" {{ old('kuesioner') === '1' ? 'selected' : '' }}>Ya</option>
                                            </select>
                                        </div>
                                        <div class="col-md-3 mb-3">
                                            <label class="form-label">Is Delete</label>
                                            <input type="text" class="form-control" name="is_delete" value="{{ old('is_delete') }}" placeholder="Kosongkan jika aktif">
                                        </div>
                                    </div>
