                            ...
                            <div class="row g-4">
                                @foreach($menus2 as $menus)
                                    <div class="col-md-6 col-lg-3">
                                        <a href="{{ $menus['url'] }}" class="text-decoration-none">
                                            <div class="card h-100 border-0 shadow-sm menu-card transition-all">
                                                <div class="card-body text-center py-5">
                                                    <div class="menu-icon mb-3">
                                                        <i class="{{ $menus['icon'] }} fa-3x text-primary"></i>
                                                    </div>
                                                    <h5 class="card-title fw-semibold mb-2">{{ $menus['title'] }}</h5>
                                                    <p class="card-text text-muted small">{{ $menus['description'] }}</p>
                                                </div>
