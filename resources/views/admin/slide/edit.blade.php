                    ...
                    <div class="filter cm-content-box box-primary">
                        ...
                        <div class="cm-content-body form excerpt">
                            ...
                            <div class="card-body pb-4">
                                <form action="{{ route('slide.update', $d->id) }}" method="POST" id="form-slide">
                                    @csrf
                                    @method('PUT')
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="link" value="{{ old('link', $d->link) }}">
                                        </div>
                                        <div class="col-md-12 mb-3">
                                            <label class="form-label">Caption <span class="text-danger">*</span></label>
                                            <textarea class="form-control js-editor" name="caption" rows="6" required>{{ old('caption', $d->caption) }}</textarea>
                                        </div>
                                    </div>
