                    ...
                    <div class="filter cm-content-box box-primary">
                        ...
                        <div class="cm-content-body form excerpt">
                            ...
                            <div class="card-body pb-4">
                                <form action="{{ url('master/rombel/' . $d->id) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="rombel"
                                                value="{{ old('rombel', $d->rombel) }}" required>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label class="form-label">Status <span class="text-danger">*</span></label>
                                            <select class="form-control" name="is_aktif" required>
                                                <option value="Aktif" {{ old('is_aktif', (string) $d->is_aktif) == 'Aktif' ? 'selected' : '' }}>Aktif</option>
                                                <option value="Tidak Aktif" {{ old('is_aktif', (string) $d->is_aktif) == 'Tidak Aktif' ? 'selected' : '' }}>Tidak Aktif</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="mt-3">
