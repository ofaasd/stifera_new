    ...
    <div class="content-body">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    <div class="mb-4 pb-3">
                        <a href="{{ url('pengumuman/create') }}" class="btn btn-success btn-round">
                                        ...
                                        @foreach($pengumumanList as $row)
                                            <tr>
                                                ...
                                                <td class="d-flex gap-1">
                                                    <a href="{{ url('pengumuman/' . $row->id . '/edit') }}" class="btn btn-success btn-sm" title="Edit">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                    <form action="{{ url('pengumuman/' . $row->id) }}" method="POST" onsubmit="return confirm('Yakin hapus pengumuman ini?')">
                                                        @csrf
                                                        @method('DELETE')
