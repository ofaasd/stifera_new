                    ...
                    <div class="filter cm-content-box box-primary">
                        ...
                        <div class="cm-content-body form excerpt">
                            ...
                            <div class="card-body pb-4">
                                <form action="{{ url('master/ruang/' . $d->id) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <label class="form-label">Nama Ruang <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" name="nama_ruang" value="{{ old('nama_ruang', $d->nama_ruang) }}" required>
                                        </div>
                                        <div class="col-md-3 mb-3">
                                            <label class="form-label">Kapasitas <span class="text-danger">*</span></label>
                                            <input type="number" min="1" class="form-control" name="kapasitas" value="{{ old('kapasitas', $d->kapasitas) }}" required>
                                        </div>
                                        <div class="col-md-3 mb-3">
                                            <label class="form-label">Luas <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" name="luas" value="{{ old('luas', $d->luas) }}" required>
                                        </div>
                                    </div>
