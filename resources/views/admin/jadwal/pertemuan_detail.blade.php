                        ...
                        <div class="card-body pb-2">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-2">
                                    <strong>RPS:</strong>
                                    @if(!empty($jadwal->rps))
                                        <a href="{{ asset('files/assets/pertemuan/' . $jadwal->rps) }}" target="_blank" class="btn btn-primary btn-sm">Lihat File</a>
                                    @else
                                        -
                                    @endif
                                </div>
                                <div class="col-md-6 mb-2">
                                    <strong>KP:</strong>
                                    @if(!empty($jadwal->kp))
                                        <a href="{{ asset('files/assets/pertemuan/' . $jadwal->kp) }}" target="_blank" class="btn btn-primary btn-sm">Lihat File</a>
                                    @else
                                        -
                                    @endif
                                </div>
