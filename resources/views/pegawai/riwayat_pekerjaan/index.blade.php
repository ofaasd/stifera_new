            ...
            <div class="col-xl-12">
                ...
                <div class="card mb-4" style="height:auto !important;">
                    <div class="card-header">
                        <h5 class="mb-0">Tambah Riwayat Pekerjaan</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('pegawai.riwayat-pekerjaan.store') }}" method="POST">
                            @csrf
                            <div class="row g-3">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="number" class="form-control" name="tahun_masuk" min="1900" max="2099" required>
                                </div>
                                <div class="col-md-2">
                ...
                <div class="card" style="height:auto !important;">
                    <div class="card-header">
                        <h5 class="mb-0">Data Riwayat Pekerjaan</h5>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped align-middle">
                                ...
                                <tbody>
                                    @forelse($riwayat as $i => $row)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form action="{{ route('pegawai.riwayat-pekerjaan.destroy', $row->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Hapus data ini?')">
                                                    @csrf
                                                    @method('DELETE')
                                        ...
                                        <div class="modal fade" id="editModal{{ $row->id }}" tabindex="-1" aria-hidden="true">
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    <form action="{{ route('pegawai.riwayat-pekerjaan.update', $row->id) }}" method="POST">
                                                        @csrf
                                                        @method('PUT')
                                                        <div class="modal-header">
                                                            <h5 class="modal-title">Edit Riwayat Pekerjaan</h5>
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="row g-3">
                                                                <div class="col-md-4">
                                                                    <label class="form-label">Posisi</label>
                                                                    <input type="text" class="form-control" name="posisi" value="{{ $row->posisi }}" required>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <label class="form-label">Perusahaan</label>
                                                                    <input type="text" class="form-control" name="perusahaan" value="{{ $row->perusahaan }}" required>
                                                                </div>
                                                                <div class="col-md-2">
                                                                    <label class="form-label">Tahun Masuk</label>
                                                                    <input type="number" class="form-control" name="tahun_masuk" min="1900" max="2099" value="{{ $row->tahun_masuk ? date('Y', strtotime($row->tahun_masuk)) : '' }}" required>
                                                                </div>
                                                                <div class="col-md-2">
                                                                    <label class="form-label">Tahun Keluar</label>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="7" class="text-center">Belum ada data riwayat pekerjaan.</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
