...
@section('content')
		<div class="content-body default-height">
			<div class="page-titles">
				<h5 class="dashboard_bar">Followers</h5>
				<ul class="breadcrumb">
						...
						<div class="col-xl-4 col-sm-6">
							<div class="card">
								<div class="card-body text-center p-4">
									...
									<div class="d-flex justify-content-center px-3 user-detail">
										<div class="bg-light rounded px-3 py-2 mx-2 flex-grow-1">
											<h6 class="mb-0">$12,500.00</h6>
											<span class="fs-13">Avg. Deal</span>
										</div>
										<div class="bg-light rounded px-3 py-2 mx-2 flex-grow-1">
											<h6 class="mb-0">$150,500.00</h6>
						...
						<div class="col-xl-4 col-sm-6">
							<div class="card">
								<div class="card-body text-center p-4">
									<div class="mx-auto d-inline-block position-relative mb-3">
										<div
											class="avatar avatar-lg style-1 bg-primary-light text-primary rounded-circle mx-auto d-flex align-items-center justify-content-center">
											K</div>
									</div>
									<div class="media-body mb-4">
										<h4 class="mb-0">
											<a href="javascript:void(0);" class="text-black">Karter</a>
										</h4>
										<p class="mb-0 fs-15">Web Designer at DexignZone.</p>
									</div>
									<div class="d-flex justify-content-center px-3 user-detail">
