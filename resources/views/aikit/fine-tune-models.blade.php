...
@section('content')
		<div class="content-body default-height">
			<div class="page-titles">
				<h5 class="dashboard_bar">Fine Tune Models</h5>
				<ul class="breadcrumb">
				...
				<div class="row">
					<div class="col-xl-12">
						<div class="alert alert-dismissible ai-header-alert fade  show mb-5" role="alert">
							This is a demo of AIKit plugin made for you to test the experience of using the plugin. Text
							& images generated in this demo are dummy. In real life, AIKit will call OpenAI API and
						...
						<ul class="nav nav-tabs style-2 mb-4" id="pills-tab" role="tablist">
							...
							<li class="nav-item" role="presentation">
								<a href="{{ url('aikit/fine-tune-models') }}" class="nav-link active">Fine-tune Models</a>
							</li>
							<li class="nav-item" role="presentation">
											...
											<div class="card-body pb-0 pt-3">
												<div class="mb-3">
													...
													<div class="my-2 d-flex align-items-center flex-wrap">
														<a href="javascript:void(0);"
															class=" btn btn-outline-primary mb-2 me-3"><svg width="19"
												...
												<div class="row">
													<div class="col-xl-12">
														...
														<label for="exampleFormControlInput2"
															class="form-label  d-block">Post type</label>
														<div class="mb-3">
	...
	Title:
							...
							<div class="tab-pane fade show active" id="jobs-tab-pane" role="tabpanel"
								aria-labelledby="jobs-tab" tabindex="0">
								<div class="card">
									<div class="card-body">
											...
											<table id="empoloyees-tblwrapper" class="table">
												...
												<tbody>
													<tr>
														...
														<td>
															<a href="javascript:void(0);"
																class="btn btn-primary light btn-sharp me-2">
