...
@section('content')
		<div class="content-body default-height">
			<div class="page-titles">
				<h5 class="dashboard_bar">Scheduled</h5>
				<ul class="breadcrumb">
					<li class="breadcrumb-item"><a href="{{ url('index') }}">
							Home </a>
					</li>
					<li class="breadcrumb-item active"><a href="javascript:void(0)">Scheduled</a></li>
				</ul>
			</div>
			<div class="container">
				<!-- row -->
				<div class="row">
					<div class="col-xl-12">
						...
						<p>AIKit Scheduled AI Generators allow you to schedule content to be generated by AI. Please
							review and edit before publishing for best results. This is not a substitute for human
							editing, but a drafting aid. Happy writing!</p>
						...
						<ul class="nav nav-tabs style-2 mb-4" id="pills-tab" role="tablist">
							...
							<li class="nav-item" role="presentation">
								<a href="{{ url('aikit/scheduled') }}" class="nav-link active">Scheduler</a>
							</li>
							<li class="nav-item" role="presentation">
