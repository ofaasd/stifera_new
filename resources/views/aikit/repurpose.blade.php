...
@section('content')
		<div class="content-body default-height">
			<div class="page-titles">
				<h5 class="dashboard_bar">Repurpose</h5>
				<ul class="breadcrumb">
					<li class="breadcrumb-item"><a href="{{ url('index') }}">
							Home </a>
					</li>
					<li class="breadcrumb-item active"><a href="javascript:void(0)">Repurpose</a></li>
				</ul>
			</div>
			<div class="container">
				<div class="row">
					<div class="col-xl-12">
						...
						<p>AIKit Auto Writer is a tool helps you write drafts quickly, but please review and edit before
							publishing for best results. This is not a substitute for human editing, but a drafting aid.
							Happy writing!</p>
						...
						<ul class="nav nav-tabs style-2 mb-4" id="pills-tab" role="tablist">
							...
							<li class="nav-item" role="presentation">
								<a href="{{ url('aikit/repurpose') }}" class="nav-link active">Repurpose</a>
							</li>
							<li class="nav-item" role="presentation">
								...
								<ul class="nav nav-tabs align-items-end" id="myTab" role="tablist">
									<li class="nav-item" role="presentation">
										<button class="nav-link active" id="create-tab" data-bs-toggle="tab"
											...
											aria-controls="create-tab-pane" aria-selected="true">Create Fine-tune
											Job</button>
									</li>
									<li class="nav-item" role="presentation">
										<button class="nav-link" id="jobs-tab" data-bs-toggle="tab"
											data-bs-target="#jobs-tab-pane" type="button" role="tab"
											aria-controls="jobs-tab-pane" aria-selected="false">Jobs<span
												class="badge badge-circle badge-light light ms-2">5</span></button>
									</li>
									...
									<div class="col-xl-4">
										<div class="card overflow-hidden h-auto">
											<div class="card-header border-0 pb-0">
												...
												<select
													class="default-select custom-image-select ai-select image-select">
											...
											<div class="card-body pb-0 pt-3">
												<div class="mb-3">
													...
													<svg class="ms-1 c-pointer" data-bs-toggle="tooltip"
														...
														<g clip-path="url(#clip0_44_4342)">
															<path
																...
																stroke-linecap="round" stroke-linejoin="round" />
															<path d="M8 10.6667V8" stroke="var(--primary)"
																stroke-width="2" stroke-linecap="round"
																stroke-linejoin="round" />
															<path d="M8 5.33301H8.00667" stroke="var(--primary)"
																stroke-width="2" stroke-linecap="round"
																stroke-linejoin="round" />
														</g>
														<defs>
													...
													<div class="my-2 d-flex align-items-center flex-wrap">
														<a href="javascript:void(0);"
															class=" btn btn-outline-primary me-3 mb-2"><svg width="19"
																height="19" viewBox="0 0 18 19" fill="none"
																xmlns="http://www.w3.org/2000/svg">
																<path d="M12.75 8H2.25" stroke="var(--primary)"
																	stroke-width="1.5" stroke-linecap="round"
																	stroke-linejoin="round" />
																<path d="M15.75 5H2.25" stroke="var(--primary)"
																	stroke-width="1.5" stroke-linecap="round"
																	stroke-linejoin="round" />
																<path d="M15.75 11H2.25" stroke="var(--primary)"
																	stroke-width="1.5" stroke-linecap="round"
																	stroke-linejoin="round" />
																<path d="M12.75 14H2.25" stroke="var(--primary)"
																	stroke-width="1.5" stroke-linecap="round"
																	stroke-linejoin="round" />
															</svg>
															Post or article
														...
														<a href="javascript:void(0);"
															class=" btn btn-outline-primary mb-2"><svg width="19"
																height="19" viewBox="0 0 18 19" fill="none"
																xmlns="http://www.w3.org/2000/svg">
																<path
												...
												<div class="row">
													<div class="col-xl-12">
														<div class="mb-3">
															<label for="exampleFormControlInput1" class="form-label">URL
																of article, post or video</label>
														...
														<div class="mb-3">
															<label for="exampleFormControlInput2"
																class="form-label">Posts to generate:</label>
															<input type="number" class="form-control"
																id="exampleFormControlInput2" placeholder="1">
														</div>
														<label for="exampleFormControlInput2" class="form-label">Post
															type</label>
														<div class="mb-3">
														...
														<div class="btn-group ai-tag-group" role="group"
															aria-label="Basic checkbox toggle button group">
															<input type="checkbox" class="btn-check" id="btncheck1">
															<label class="btn btn-outline-primary btn-sm mb-0"
																for="btncheck1">Include featured image</label>
														</div>
														<hr
															style="margin-left:-31px; margin-right:-31px; margin-bottom:0;">
													</div>
												</div>
											</div>
													...
													<a href="javascript:void(0);" class="btn btn-primary">
														<svg width="20" height="20" viewBox="0 0 20 20" fill="none"
															...
															<g clip-path="url(#clip0_28_2466)">
																<path d="M0.833496 3.33301V8.33301H5.8335"
																	stroke="white" stroke-width="2"
																	stroke-linecap="round" stroke-linejoin="round" />
																<path d="M19.1665 16.667V11.667H14.1665" stroke="white"
																	stroke-width="2" stroke-linecap="round"
																	stroke-linejoin="round" />
																<path
									...
									<div class="col-xl-8">
										<div class="accordion">
											<div class="accordion-item">
												<div class="accordion-header prompt-header rounded-lg" id="headingOne"
												...
												<div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
													...
													<div class="accordion-body-text">
														<div class="d-flex align-items-center mb-1">
															...
															<span
																class="badge badge-sm badge-danger light ms-1">description</span>
															<span class="mx-1">,</span>
															<span
																class="badge badge-sm badge-danger light">section-headlines</span>
														</div>
														<div class="mb-3">
	...
	Title:
														...
														<div class="mb-3">
															<textarea class="form-control bg-transparent"
																id="exampleFormControlTextarea7" rows="3">
	Generate a title for an article that discusses the following topic:
	[[description]]
	The article will include the following sections:
	[[section-headlines]]
										...
										<div class="table-responsive active-projects style-1">
											<table id="empoloyees-tblwrapper" class="table">
												...
												<tbody>
													<tr>
														<td><a
																href="javascript:void(0);">www.wsj.com/articles/harvard-discriminates-against-middle-class-kids-legacy-admissions-court-85cf4503</a>
														</td>
														<td>
															URL
														</td>
														...
														<td>
															<a href="javascript:void(0);"
																class="btn btn-primary light btn-sharp">
															...
															<a href="javascript:void(0);"
																class="btn btn-danger light btn-sharp">
																<svg width="15" height="16" viewBox="0 0 15 16"
																	fill="none" xmlns="http://www.w3.org/2000/svg">
																	<path d="M1.875 4.25H3.125H13.125" stroke="#FF5B5B"
																	...
																	<path
																		...
																		stroke="#FF5B5B" stroke-width="1.2"
																		stroke-linecap="round"
																		stroke-linejoin="round" />
																	<path d="M6.25 7.375V11.125" stroke="#FF5B5B"
																		stroke-width="1.2" stroke-linecap="round"
																		stroke-linejoin="round" />
																	<path d="M8.75 7.375V11.125" stroke="#FF5B5B"
																		stroke-width="1.2" stroke-linecap="round"
																		stroke-linejoin="round" />
																</svg>
															</a>
